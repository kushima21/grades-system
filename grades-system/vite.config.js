...
export default defineConfig({
    plugins: [
        laravel({
            ...
            input: ['resources/css/user.css', 'resources/js/app.js'],
            input: ['resources/css/departments.css', 'resources/js/app.js'],
            input: ['resources/css/grading_view', 'resources/js/app.js'],
            input: ['resources/css/academic_grades', 'resources/js/app.js'],
            input: ['resources/css/student_grades', 'resources/js/app.js'],
            input: ['resources/css/students', 'resources/js/app.js'],
            refresh: true,
        }),
        tailwindcss(),
    ],
