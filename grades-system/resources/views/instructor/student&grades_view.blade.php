...
<div class="grading-score-main-container">
    ...
    <div class="student-grades-m-container">
        ...
        <div class="student-grades-wrapper">
            ...
            @php
                $locked = isset($departmentStatus[$department]) && $departmentStatus[$department]->status == 'Locked';
                $submitted = isset($departmentStatus[$department]) && $departmentStatus[$department]->submit_status == 'Submitted';
            @endphp
    ...
    {{-- SUBMIT TO DEAN: show only if locked --}}
    @if($locked)
